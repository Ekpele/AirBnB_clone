#!/usr/bin/python3
""" This represents the entry point of our command """
...
class HBNBCommand(cmd.Cmd):
    """This represents the HBNBCommand"""
    ...
    def do_quit(self, arg):
        """We exit the program with this command"""
        return True
    ...
    def do_create(self, line):
        """This enable us create instance of basemodel, save it and print id"""
        args = line.split()
        if len(args) == 0:
